...
export const SECTIONS = {
  ...
  portraits: {
    ...
    items: [
      ...
      { file: 'photos-1787780015524-50br.jpg', slug: 'portrait-7', alt: 'Portrait on a pier boardwalk', caption: 'On the boardwalk, golden hour.' },
      { file: '20260613-DSCF4919.jpeg', slug: 'portrait-8', alt: 'Portrait in silver dress, garden backdrop', caption: 'Silver dress, soft green backdrop.' },
      { file: '20260613-DSCF5057.jpeg', slug: 'portrait-9', alt: 'Portrait in white lace top inside a garage', caption: 'White lace, workshop backdrop.' },
      { file: '20260704-DSCF6010.jpeg', slug: 'portrait-10', alt: 'Black and white portrait in pleated skirt outdoors', caption: 'Monochrome, open field at dusk.' },
      { file: '20260704-DSCF6067.jpeg', slug: 'portrait-11', alt: 'Kinetic water sculpture with model out of focus', caption: 'Kinetic fountain, layered depth of field.' },
      { file: '20260708-DSCF6304.jpeg', slug: 'portrait-12', alt: 'Portrait in metallic dress beside water sculpture', caption: 'Metallic dress, industrial fountain backdrop.' },
      { file: '20260708-DSCF6347.jpeg', slug: 'portrait-13', alt: 'Portrait leaning against wire mesh wall', caption: 'Leaning into the frame, wire mesh texture.' },
      ...
      { file: '20260708-DSCF6523.jpeg', slug: 'portrait-15', alt: 'Portrait against greenery, hand in hair', caption: 'Green backdrop, quiet upward gaze.' },
      { file: '20260708-DSCF6544-3.jpeg', slug: 'portrait-16', alt: 'Portrait inside a car, seatbelt across frame', caption: 'In the car, candid and unposed.' },
      { file: '20260708-DSCF6555.jpeg', slug: 'portrait-17', alt: 'Portrait in trench coat against garage door', caption: 'Trench coat, evening light on steel.' },
    ],
  },
